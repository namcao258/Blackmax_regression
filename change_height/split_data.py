...
original_csv_path = '/media/namcao/NAM CAO/Ubuntu/Blackmax_regression/change_height/image_data_time_2.csv'
original_img_dir = '/media/namcao/NAM CAO/Ubuntu/Blackmax_regression/change_height/data_bw_time_2_new'

# Paths for the new train and test data
train_csv_path = '/media/namcao/NAM CAO/Ubuntu/Blackmax_regression/change_height/train_data.csv'
test_csv_path = '/media/namcao/NAM CAO/Ubuntu/Blackmax_regression/change_height/test_data.csv'
